...
public class Insumos {
    ...
    private int id;
    private String [] insumos ={"Conos", "Bandas elasticas", "Tabla para flexiones", "Cuerda de salto", "zapatillas running", "botella de agua", "mancuernas" };
    private int[] precios ={12990,7990,13640,14990, 29900, 5900, 35000 };
    private int stock;
